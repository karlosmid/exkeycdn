...
Mox.defmock(ExKeyCDN.MockZoneReferrer, for: ExKeyCDN.ZoneReferrerBehaviour)
Application.put_env(:exkeycdn, :zone_referrer, ExKeyCDN.MockZoneReferrer)
Mox.defmock(ExKeyCDN.MockReport, for: ExKeyCDN.ReportBehaviour)
Application.put_env(:exkeycdn, :report, ExKeyCDN.MockReport)
